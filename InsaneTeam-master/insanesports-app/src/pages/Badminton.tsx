...
function Badminton() {
    const eastMatch = useMatch(`/badminton/east`);
    const northMatch = useMatch(`/badminton/north`);
    const southMatch = useMatch(`/badminton/south`);
    const westMatch = useMatch(`/badminton/west`);
    return (
        <Container>
            <Menubar />
            <MainContainer>
